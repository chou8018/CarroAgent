...
const PaymentScreen: React.FC = () => {
  ...
  useEffect(() => {
    const fetchFormData = async () => {
      try {
        const data = await RequestQuoteService.getPaymentForm(
          item.id.toString()
        );
        setFormData(data);
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Fill in Payment Details</Text>
      <Text style={styles.subtitle}>Carplate No.: {item.car_plate}</Text>
      <Text style={styles.subtitle}>Price:{item.price_value}</Text>
      <Text style={styles.subtitle}>Processing Fee: {item.processing_fee}</Text>
      <Text style={styles.subtitle}>Owner’s Name: {item.owner_name}</Text>
      <Text style={styles.subtitle}>
        Owner’s Contact No.: {item.owner_phone_no}
      </Text>
